...
import { updateFullAddress } from './../actions.js'

class AddressPicker extends React.Component {
    constructor(props) {
        super(props)
        this.cities = Object.keys(props.taiwanPostalCode)
                ...
                <Card>
                    <CardPrimaryContent>
                        <div
                            ...
                            <div style={{width:"100%",marginTop:"24px",marginBottom:"-12px"}}>
                                {/* 此 div 只是修正 Google Material Component 3.2 的跑版問題 */}
                                <Select
                                    label='市/區'
                                    name="district"
                                    value={district}
...
const mapDispatchToProps = { updateFullAddress }
