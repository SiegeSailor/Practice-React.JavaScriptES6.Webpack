var globalAnnouncement = "global 使用：";

// ## ES5 中 scope 內宣告的變數會溢出到 global 中，然而在比較嚴謹的語言如 C，scope 內宣告的變數只會存在 scope 中
// # variable
if (true) {
    var scopeVariable = "宣告於 scope 中的 variable。<br>";
}
document.write(globalAnnouncement + scopeVariable);
// # function
if (true) {
...
scopeFunction();
// # global function 與 scope function。scope 內的 function 會覆蓋 global 宣告的 function
...
functionComparison();
// # 即使是之前引入的 library，仍然會覆蓋掉。若註解以下 scope 的 function，則會執行 3-ScopeLibrary.js 的 function
if (true) {
    function functionLibraryComparison() {
        document.write(globalAnnouncement + "宣告於 3-Scope.js 內的 scope 中的 function。<br>")
    }
}
functionLibraryComparison();

var scopeAnnouncement = "scope 使用：";

// ## ES6 中，若都在一個巢狀 scope 內，或使用 let 宣告，則 function 間不會溢出
// # 巢狀 scope
{
    function functionComparisonScopeES6() {
...
// # let 宣告
let functionComparisonLetES6 = function () {
