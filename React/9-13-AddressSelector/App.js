...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _TaiwanPostalCode_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TaiwanPostalCode.json */ \"./TaiwanPostalCode.json\");\nvar _TaiwanPostalCode_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./TaiwanPostalCode.json */ \"./TaiwanPostalCode.json\", 1);\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(source, true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\nvar AddressPicker =\n/*#__PURE__*/\nfunction (_React$Component) {\n  _inherits(AddressPicker, _React$Component);\n\n  function AddressPicker(props) {\n    var _this;\n\n    _classCallCheck(this, AddressPicker);\n\n    _this = _possibleConstructorReturn(this, _getPrototypeOf(AddressPicker).call(this, props));\n\n    _defineProperty(_assertThisInitialized(_this), \"renderOptions\", function (targets) {\n      return targets.map(function (target, index) {\n        return (// # 重新繪製時，React 可以比對前後兩者的差異，進而減少效能消耗\n          // 這當中，靠的就是用獨特的 key 比對。這邊因為每個 target ( 在這裡是 city 或 district ) 不同，固當作 key 使用\n          React.createElement(\"option\", {\n            key: target,\n            value: target\n          }, target)\n        );\n      });\n    });\n\n    _defineProperty(_assertThisInitialized(_this), \"handlerRelated\", function (name, value) {\n      // 利用 ES6 ... 的合併特性作判斷處理\n      var mergeObject = {};\n\n      if (name == \"city\" && _this.state.city != value) {\n        mergeObject[\"district\"] = \"\";\n        mergeObject[\"postalCode\"] = \"\";\n      } else if (name == \"district\" && _this.state.postalCode != value) {\n        var cityData = _this.postalCode[_this.state.city];\n        var postalCode = cityData[value];\n        mergeObject[\"postalCode\"] = postalCode;\n      }\n\n      return mergeObject;\n    });\n\n    _defineProperty(_assertThisInitialized(_this), \"handler\", function (event) {\n      var _event$target = event.target,\n          name = _event$target.name,\n          value = _event$target.value; // 選擇完 city 後 district 會變動，但真正 state 裡面的 district 是在 district 的選擇後才變動的\n      // 因此設立條件，使選擇 city 後的 district 清空\n      // if (name == `city` && this.state.city != value) {\n      //     this.setState({[name]: value, district: \"\"}, ()=>{\n      //         console.log(this.state)\n      //     })\n      // } else {\n      //     this.setState({ [name]: value }, () => {\n      //         console.log(this.state)\n      //     })\n      // }\n\n      var mergeObject = _this.handlerRelated(name, value); // 如果上述 if 成真 ( 即選擇 city 後的第一次顯示 )，則 margeObject 就有了 district 為空的 object\n      // 使用 ... 合併的情況下，會優先留有 ... 的值，因此 mergetObject 的 district 的空值會覆蓋 this.state.district\n      // postalCode 同理\n\n\n      _this.setState(_objectSpread({}, mergeObject, _defineProperty({}, name, value)), function () {\n        console.log(_this.state);\n      });\n    });\n\n    _defineProperty(_assertThisInitialized(_this), \"render\", function () {\n      var cityOptions = _this.renderOptions(_this.cities); // 由於區域在城市下，而城市會隨時更動，因此 district 的取得需在 render 時\n\n\n      var cityData = _this.postalCode[_this.state.city];\n      var district = Object.keys(cityData);\n\n      var districtOptions = _this.renderOptions(district);\n\n      return React.createElement(\"div\", null, React.createElement(\"label\", {\n        htmlFor: \"\"\n      }, \"\\u57CE\\u5E02\", React.createElement(\"select\", {\n        name: \"city\",\n        id: \"\",\n        onChange: _this.handler,\n        value: _this.state.city\n      }, cityOptions)), React.createElement(\"br\", null), React.createElement(\"label\", {\n        htmlFor: \"\"\n      }, \"\\u5E02 / \\u5340\", React.createElement(\"select\", {\n        name: \"district\",\n        id: \"\",\n        onChange: _this.handler,\n        value: _this.state.district\n      }, districtOptions)), React.createElement(\"br\", null), React.createElement(\"label\", {\n        htmlFor: \"\"\n      }, \"\\u90F5\\u905E\\u5340\\u865F\", React.createElement(\"input\", {\n        name: \"postalCode\",\n        value: _this.state.postalCode,\n        disabled: true,\n        type: \"text\"\n      })), React.createElement(\"br\", null), React.createElement(\"label\", {\n        htmlFor: \"\"\n      }, \"\\u5730\\u5740\", React.createElement(\"input\", {\n        name: \"address\",\n        onChange: _this.handler,\n        value: _this.state.address,\n        type: \"text\"\n      })));\n    });\n\n    _this.postalCode = _TaiwanPostalCode_json__WEBPACK_IMPORTED_MODULE_0__;\n    _this.cities = Object.keys(_this.postalCode);\n    _this.state = {\n      city: \"\\u65B0\\u7AF9\\u5E02\",\n      district: \"\",\n      postalCode: \"\",\n      address: \"\"\n    };\n    return _this;\n  }\n\n  return AddressPicker;\n}(React.Component);\n\n;\n/* harmony default export */ __webpack_exports__[\"default\"] = (AddressPicker);\n\n//# sourceURL=webpack:///./AddressPicker.jsx?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _AddressPicker_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AddressPicker.jsx */ \"./AddressPicker.jsx\");\nfunction _typeof(obj) { if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\nvar App =\n/*#__PURE__*/\nfunction (_React$Component) {\n  _inherits(App, _React$Component);\n\n  function App() {\n    var _getPrototypeOf2;\n\n    var _this;\n\n    _classCallCheck(this, App);\n\n    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {\n      args[_key] = arguments[_key];\n    }\n\n    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(App)).call.apply(_getPrototypeOf2, [this].concat(args)));\n\n    _defineProperty(_assertThisInitialized(_this), \"render\", function () {\n      return React.createElement(_AddressPicker_jsx__WEBPACK_IMPORTED_MODULE_0__[\"default\"], null);\n    });\n\n    return _this;\n  }\n\n  return App;\n}(React.Component);\n\nReactDOM.render(React.createElement(App, null), document.getElementById(\"app\"));\n\n//# sourceURL=webpack:///./App.jsx?");

/***/ }),

/***/ "./TaiwanPostalCode.json":
/*!*******************************!*\
  !*** ./TaiwanPostalCode.json ***!
  \*******************************/
